    ...
    <div class="card col-sm-12">
        ...
        <div class="card-body">
            <div class="row no-gutters">
                <div class="col-md-5">
                    <form method="POST" action="<?php echo site_url('penjualan/cetaklaporanperperiode') ?>">
                        <table>
                            <tr>
                                <div class="col-md">
                                    <div class="card card-solid">
                                        <div class="card-header" style="background-color: #ffc107">
                                            <div class="card-title"><Center><h5><b>Laporan Penjualan Perperiode</b></h5></Center></div>
                                        </div>
                                        <div class="card-body">
